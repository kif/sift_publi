...
alignment on this lign. Figure \ref{fig:alignment} highlights this by taking a
vertical section of the sample at $x=500$ and $y\in[475, 600]$
(picture coordinates of figure \ref{fig:sample}) as horizontal axis and the
frame number on the verical axis (this is similar to the energy but
...
indicates the derivative of the transmission to highligh the sample boundaries.
...
phase correlation where deviation of more than than 2 pixels have been measured.

\begin{figure}
\label{fig:alignment}
\begin{center}
\includegraphics[width=12cm]{alignment.eps}
...
a vertical line at $x=500, y\in[475, 600]$ in figure \ref{fig:sample}}
\end{center}
\end{figure}
