...
online processing of large dataset.
...
but also associated to the $scale$ of the feature and it's
orientation (or $angle$).
This makes those keypoints naturally robust to
...
it is the normalized X-Ray transmission at the K edge of sulfure of a painting
...
taken at ID21 at the suflure K-edge. Arrows represent the position of SIFT-keypoints, in red
...
SIFT\_PyOCL is a Python library implementating this algorithm for GPU
